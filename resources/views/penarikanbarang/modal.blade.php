            ...
            <div class="modal-body">
                <form action="{{ url('penarikanbarang') }}" class="form-horizontal" method="post">
                    ...
                    <div class="form-group row">
                        <input type="hidden" name="idb" id="barangId">
                        <!-- <input type="text" name="id" id="i"> -->
                        ...
                        <div class="col-sm-9">
                            <select name="kode_barang" id="kode_barang" class="form-control select2"
                                style="width: 100%;">
                                <option value="" disabled>== Masukkan Kode Barang ==</option>
                                @foreach ($barang as $key => $value)
                                <option value="{{ $value->kode_barang }}">{{ $key + 1 }} - {{ $value->kode_barang }}
                                </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="text" autocomplete="off" id="nama_barang" name="nama_barang" readonly
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="inputTanggal" name="tanggal_expire" required
